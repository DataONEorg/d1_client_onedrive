...
class TestMockup(unittest.TestCase):
  ...
  def test_200_get_all_children(self):
    self.assertEqual(self._get_paths(self.c._get_all_children('')), ['d/d2/f3a', 'd/d2/f3b', 'd/f2a', 'd/f2b', 'd/f2c', 'fa', 'fb'])
    self.assertEqual(self._get_paths(self.c._get_all_children('d/d2')), ['d/d2/f3a', 'd/d2/f3b'])
  ...
  def test_600_get_meta_file(self):
    self.assertEqual(self.c._get_meta_file('fa'), (50, datetime.datetime(2005, 5, 23, 11, 12, 13)))
    self.assertEqual(self.c._get_meta_file('d/d2/f3b'), (56, datetime.datetime(2005, 5, 23, 11, 12, 13)))
