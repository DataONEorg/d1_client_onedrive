...
all_facet_names = [
  'origin', 'noBoundingBox', 'endDate', 'family', 'text', 'abstract',
  'rightsHolder', 'LTERSite', 'site', 'datePublished', 'topic', 'edition',
  'geoform', 'phylum', 'gcmdKeyword', 'keywords', 'genus', 'titlestr', 'id',
  'decade', 'size', 'sku', 'isSpatial', 'documents', 'changePermission',
  'authorLastName', 'author', 'termText', 'species', 'source', 'formatId',
  'contactOrganizationText', 'obsoletes', 'projectText', 'updateDate',
  'obsoletedBy', 'parameter', 'dateModified', 'datasource', 'kingdom',
  'topicText', 'southBoundCoord', 'westBoundCoord', 'northBoundCoord',
  'isPublic', 'namedLocation', 'contactOrganization', 'investigatorText',
  'formatType', 'resourceMap', 'readPermission', 'originator', 'keyConcept',
  'writePermission', 'siteText', 'class', 'parameterText', 'originatorText',
  'term', 'identifier', 'pubDate', 'eastBoundCoord', 'keywordsText',
  'dateUploaded', 'sensor', 'beginDate', 'title', 'order', 'sourceText',
  'presentationCat', 'scientificName', 'sensorText', 'placeKey', 'originText',
  'submitter', 'isDocumentedBy', 'relatedOrganizations', 'project',
  'investigator', 'fileID', 'purpose',
]

field_names_good_for_faceting = [
  'abstract', 'author', 'authorLastName', 'changePermission', 'class',
  'contactOrganization', 'datasource', 'decade', 'documents',
  'eastBoundCoord', 'edition', 'family', 'fileID', 'formatId',
  'formatType', 'gcmdKeyword', 'genus', 'geoform', 'id', 'identifier',
  'investigator', 'isDocumentedBy', 'isPublic', 'isSpatial', 'keyConcept',
  'keywords', 'kingdom', 'LTERSite', 'namedLocation', 'noBoundingBox',
  'northBoundCoord', 'obsoletedBy', 'obsoletes', 'order', 'origin',
  'originator', 'parameter', 'phylum', 'placeKey', 'presentationCat',
  'project', 'purpose', 'readPermission', 'relatedOrganizations',
  'resourceMap', 'rightsHolder', 'scientificName', 'sensor', 'site',
  'size', 'sku', 'source', 'southBoundCoord', 'species', 'submitter',
  'term', 'text', 'title', 'titlestr', 'topic', 'westBoundCoord',
  'writePermission'
]
...
class TestSolrClient(unittest.TestCase):
  ...
  def _test_100_unapplied_facets(self):
    self.assertEqual(self.c.get_unapplied_facets(['a','b','c','d'],
                                                 ['b', 'd']), ['a', 'c'])
