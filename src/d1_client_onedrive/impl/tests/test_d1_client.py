...
class TestObjectTree(unittest.TestCase):
  ...
  def test_130(self):
    ...
    with object_tree.ObjectTree(object_tree_def_path='object_tree_single.xml',
  ...
  def _test_1000(self):
    ...
    with tempfile.NamedTemporaryFile(delete=False) as f:
      pickle.dump([], f)
      f.close()
      with object_tree.ObjectTree(object_tree_cache_path=f.name,
                               object_tree_def_path='object_tree_empty.xml') as w:
        w.refresh()
