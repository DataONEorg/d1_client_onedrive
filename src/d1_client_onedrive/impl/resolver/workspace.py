...
class Resolver(resolver_abc.Resolver):
  ...
  def get_attributes(self, path, fs_path=''):
    ...
    workspace_folder_objects = WorkspaceFolderObjects(self.command_processor,
                                                      workspace_folder)
    return self.resolvers[resolver].get_attributes(controlled_path, workspace_folder_objects)
  ...
  def read_file(self, path, size, offset, fs_path=''):
    ...
    return self.resolvers[resolver].read_file(controlled_path,
      workspace_folder_objects, size, offset)
