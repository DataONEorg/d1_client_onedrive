...
class Resolver(resolver_base.Resolver):
  ...
  def _get_attributes(self, object_tree_folder, path):
    ...
    if self._region_tree_item_is_pid(region_tree_item):
      try:
        return self._resource_map_resolver.get_attributes(object_tree_folder, [region_tree_item] + unconsumed_path)
  ...
  def _get_directory(self, object_tree_folder, path):
    ...
    if self._region_tree_item_is_pid(region_tree_item):
      ...
      return self._resource_map_resolver.get_directory(object_tree_folder, [region_tree_item] + unconsumed_path)
      #else:
  ...
  def _read_file(self, object_tree_folder, path, size, offset):
    ...
    if self._region_tree_item_is_pid(region_tree_item):
      return self._resource_map_resolver.read_file(object_tree_folder, [region_tree_item] + unconsumed_path, size, offset)
